...
from api.repository.product_repository import repo_create_product, repo_update_product_desc, repo_update_product_stock, repo_get_product
...
def update_product_desc(productDescData: ProductDescData):
    try:
        ...
        product_desc_data = ProductDescData(product_code, product_name, product_version)
...
def update_product_stock(productStock: ProductStock):
    try:
        ...
        if productStock.mutator in _mutators:
            ...
            product_stock_data = ProductStockData(prod_code, updated_stock, new_product_version)
